...
- [Isotypical_decomposition: scalar-valued case](#Isotypical decomposition: scalar-valued case)
- [Isotypical decomposition: vector-valued case](#Isotypical decomposition: vector-valued case)
